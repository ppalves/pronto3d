  ...
  <section id="intro">
    ...
    <div class="intro-text">
      <h2>PRONTO 3D</h2>
      <p>Laboratório de Prototipagem e Novas Tecnologias Orientadas ao 3D</p>
      <a href="#about" onclick="enviaEmail()" class="btn-get-started scrollto">Get Started</a>
    </div>
<!--
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 content wow fadeInRight">
            ...
            <ul>
              <li><i class="ion-android-checkmark-circle"></i> Lúdico</li>
              <li><i class="ion-android-checkmark-circle"></i> Eficiente</li>
        ...
        <div class="row">
          ...
          <div class="col-lg-8 offset-lg-4">
            <div class="section-header wow fadeIn" data-wow-duration="1s">
              <h3 class="section-title">A rede</h3>
              <span class="section-divider"></span>
            </div>
          </div>
