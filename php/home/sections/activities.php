    ...
    <section id="more-features" class="section-bg">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg box wow fadeInUp mr-2 ml-2">
            <div class="row">
          ...
          <div class="col-lg box wow fadeInUp ml-2 mr-2">
            <div class="row">
              <div class="col-lg-4" style="margin-top: 20px;">
          ...
          <!-- <div class="col-lg-5 box wow fadeInRight ml-auto mr-auto">
            <div class="row">
              <div class="col-lg-4" style="margin-top: 20px;">
                <div class="icon"><img src="img/icons/new/PRONTOKIDS.png" alt="pesquisa" width="100%"></div>
              </div>
              <div class="col-lg-8">
                <h4 class="title"><a href="">Pronto Kids</a></h4>
                <p class="description">
                O PRONTOKids é uma atividade direcionada a crianças até 12 anos, com oficinas lúdicas onde a tecnologia é encarada como parte do processo. Geralmente, é a escola que identifica o tema a ser desenvolvido e a equipe do PRONTO3D elabora e conduz as atividades.
                </p>
              </div>
            </div>
          </div> -->
